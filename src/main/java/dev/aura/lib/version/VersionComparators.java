...
/** This class defines a bunch of default comparators for simplicity and convenience. */
@UtilityClass
public class VersionComparators {
   ...
   * <br>
   * Equivalent to {@link Comparator#comparing(Function) Comparator.comparing(Version::new,
   * VersionComparators.VERSION)}
   *
   * @see Comparator#comparing(Function)
   * @see Comparator#naturalOrder()
   */
  public static final Comparator<String> VERSION_STRING =
      Comparator.comparing(Version::new, VERSION);

  /**
   * Compares two {@link Version} objects in reversed order.<br>
   * <br>
   * Equivalent to {@link Comparator#reversed() VersionComparators.VERSION.reversed()}
   *
  ...
  /**
   * Converts two strings to {@link Version} objects and compares these in reversed order.<br>
   * <br>
   * Equivalent to {@link Comparator#reversed() VersionComparators.VERSION_STRING.reversed()}
   *
   * @see Comparator#reversed()
   * @see Comparator#comparing(Function)
   * @see Comparator#naturalOrder()
